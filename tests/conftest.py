...
@pytest.fixture
def category_info1():
    return Category(name="Телефоны",
                    description="Телефоны разные, от новых до убитых",
                    products=[Product("Samsung Galaxy S23 Ultra","Телефон новый,просто немножко упал(не работает камера)",3999, 1),
...
def category_info2():
    return Category(name="Телевизоры",
                    description="Новые",
                    products=[Product("Pazz", "Телевизор 55 дюймов HC55USS26F UHD 4К Smart ОС Салют WiFi", 20140, 4),
